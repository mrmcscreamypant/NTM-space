...
public class ResourceManager {
	...
	public static final IModelCustom soyuz_lander_neo = new HFRWavefrontObject(new ResourceLocation(RefStrings.MODID, "models/soyuz_lander_neo.obj")).asDisplayList();
