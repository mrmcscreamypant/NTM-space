...
public class ChunkProviderTrash implements IChunkProvider
{
    /** RNG. */
    ...
    public ChunkProviderTrash(World par1World, long seed, boolean mapFeaturesEnabled)
    {
...
//        this.mapFeaturesEnabled = par4;
		...
		fillblock = ModBlocks.block_scrap;
