...
public class WorldGeneratorTrash implements IWorldGenerator {

	@Override
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider) {
		if(world.provider.dimensionId == SpaceConfig.dunaDimension) {
			generateTrash(world, random, chunkX * 16, chunkZ * 16);
		}
	}
	private void generateTrash(World world, Random rand, int i, int j) {
