...
package com.hbm.dim.trashland.biome;
...
import com.hbm.dim.trashland.BiomeGenBaseTrash;
import com.hbm.dim.trashland.TrashlandBiomeBase;
import com.hbm.dim.trashland.genlayertrash.GenLayerTrash;
...
public class WorldChunkManagerTrash extends WorldChunkManager
{
	...
	protected WorldChunkManagerTrash()
	{
		this.myBiomeCache = new BiomeCache(this);
		this.myBiomesToSpawnIn = new ArrayList();

		this.myBiomesToSpawnIn.add(TrashlandBiomeBase.dunaPolar);
		this.myBiomesToSpawnIn.add(TrashlandBiomeBase.dunaHills);
		this.myBiomesToSpawnIn.add(TrashlandBiomeBase.dunaPolarHills);
	}

	public WorldChunkManagerTrash(long seed, WorldType type)
	{
		this();
		GenLayer[] genLayers = GenLayerTrash.makeTheWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public WorldChunkManagerTrash(World world)
	{
	...
	public BiomeGenBase getBiomeGenAt(int par1, int par2)
	{
		...
		if (biome == null)
		{
			return TrashlandBiomeBase.dunaHills;
		}
		return biome;
	}
	...
	public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] par1ArrayOfBiomeGenBase, int x, int z, int length, int width)
	{
		...
		for (int i = 0; i < length * width; i++)
		{
			...
			{
				par1ArrayOfBiomeGenBase[i] = TrashlandBiomeBase.dunaHills;
			}
		}
