...
public class WorldProviderTrash extends WorldProvider {
    private float[] colorsSunriseSunset = new float[4];

	public void registerWorldChunkManager() {
		
		this.worldChunkMgr = new WorldChunkManagerTrash(worldObj);
    ...
    {
        return new ChunkProviderTrash(this.worldObj, this.getSeed(), false);
    }
    ...
    public Vec3 getFogColor(float x, float y) {
      ...
      return Vec3.createVectorHelper(14F / 255F * f, 102F / 255F * f, 8F / 255F * f);
    }
    
    public Vec3 getSkyColor(Entity camera, float partialTicks) {
        float f = 1.0F - this.getStarBrightness(1.0F);
      return Vec3.createVectorHelper(15 / 255.0F * f, 169 / 255.0F * f, 8 / 255.0F * f);
    }
