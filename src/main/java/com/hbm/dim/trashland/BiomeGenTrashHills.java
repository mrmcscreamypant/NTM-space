...
public class BiomeGenTrashHills extends BiomeGenBase {
	
    public static final BiomeGenBase.Height height = new BiomeGenBase.Height(0.825F, 0.9F);

    //TODO: avoid doing an extra planets and make each planet unique and cool.
	public BiomeGenTrashHills(int id) {
		super(id);
		this.setBiomeName("Weathered Trash Hills");
		this.setDisableRain();
